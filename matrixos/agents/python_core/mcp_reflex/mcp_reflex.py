...
WORKER_SHA256 = "1b36e2c52d036fb84f1bddeccbf2f2213e427aad4a2d740a168f446f876ac9e7"
...
class Agent(BootAgent):
    ...
    def _invoke_worker(self, payload: Mapping[str, Any]) -> dict[str, Any]:
        ...
        completed = subprocess.run(
            ...
            stderr=subprocess.DEVNULL, env=worker_env, timeout=self._worker_timeout,
            check=False,
        )
        if len(completed.stdout) > self._max_result_bytes:
