...
class DiscordRelay(BaseEditor, ServiceRolesMixin):
    """Edit Discord alert delivery and alert-payload protection."""
    ...
    def _build_form(self):
        ...
        self.alerts_enabled = QCheckBox("Enable Discord alert delivery")
        self.alerts_enabled.setChecked(bool(cfg.get("alerts_enabled", True)))
        form.addRow(self.alerts_enabled)

        self.encrypt_alerts = QCheckBox("Encrypt Discord alert message")
        ...
        self.layout.addRow(QLabel("🔐 Discord Alert Security"))
