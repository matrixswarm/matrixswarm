...
# MATRIX EMAIL EGRESS Config Editor
...
class MatrixEmailEgress(BaseEditor, ServiceRolesMixin):
    ...
    def _build_form(self):
        ...
        self.layout.addRow(QLabel("📡 Matrix Email Egress Settings"))
        ...
        self._build_roles_section(cfg, default_role="matrix_email_egress.status@cmd_status")
